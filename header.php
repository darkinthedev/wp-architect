...
<?php //ARIA 'role' http://www.paciellogroup.com/blog/2012/06/html5-accessibility-chops-when-to-use-an-aria-role/ ?>
	<header id="branding" role="banner">
		...
		<nav id="access" role="navigation">
			<h1 class="assistive-text section-heading"><?php _e( 'Main menu', 'mrestarter' ); ?></h1>
			
			<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'mrestarter' ); ?>"><?php _e( 'Skip to content', 'mrestarter' ); ?></a></div>
